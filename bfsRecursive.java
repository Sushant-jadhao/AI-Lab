...
public class bfsRecursive {
    ...
    public static void bfsRecursiveHelper(Queue<State> queue, Set<State> visited, Map<State, State> parent) {
        if (queue.isEmpty()) {
            return;
        }
        ...
        bfsRecursiveHelper(queue, visited, parent);
    }
    ...
    public static void main(String[] args) {
        System.out.println("Breadth First Search Missionary and Cannibals Problem");
        bfsMC();
    }
}
